...
КовКод — один APK, который разворачивает полноценный Linux-рабочий стол на Android-устройстве без root-прав. Проект рассчитан на тех, кому нужен мобильный компьютер для документов, разработки, браузера и повседневной работы, а не только эмулятор терминала.
